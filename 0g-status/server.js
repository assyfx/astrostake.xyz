...
const RPCS = [
  ...
  { name: "Maouam Nodelab", url: "https://0g-evm.maouam.nodelab.my.id/" },
  ...
  for (const rpc of RPCS) {
    try {
      ...
      cachedBlocks[rpc.name] = {
        ...
        block: !isNaN(blockNumber) ? blockNumber : cachedBlocks[rpc.name]?.block || "0",
      ...
      cachedBlocks[rpc.name] = {
        status: "Offline",
        block: cachedBlocks[rpc.name]?.block || "0",
        latency: 0,
